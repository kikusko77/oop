...
namespace PharmacyApp.EFCore
{
    public class PharmacyDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ChristianKu\Desktop\New folder\oop\projekt\PharmacyApp\DrugDatabase.mdf; Connect Timeout=30");
